    ...
    public class DarkToolStripRenderer : DarkMenuRenderer
    {
        ...
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
        {
            ...
            if (e.ToolStrip is ToolStripOverflow)
                ...
                {
                    var rect = new Rectangle(e.AffectedBounds.Left, e.AffectedBounds.Top, e.AffectedBounds.Width - 1,
        ...
        protected override void OnRenderItemImage(ToolStripItemImageRenderEventArgs e)
        {
            ...
            if (!e.Item.Enabled)
                using (var b =
                    new SolidBrush(Color.FromArgb(180, e.Item.BackColor.R, e.Item.BackColor.G, e.Item.BackColor.B)))
                {
