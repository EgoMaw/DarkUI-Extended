...
namespace DarkUI.Renderers
{
    public class DarkMenuRenderer : ToolStripRenderer
    {
        ...
        protected override void InitializeItem(ToolStripItem item)
        {
            ...
            if (item.GetType() == typeof(ToolStripSeparator)) item.Margin = new Padding(0, 0, 0, 1);
        }
        ...
        protected override void OnRenderItemCheck(ToolStripItemImageRenderEventArgs e)
        {
            ...
            if (e.Item.ImageIndex == -1 && string.IsNullOrEmpty(e.Item.ImageKey) && e.Item.Image == null) g.DrawImageUnscaled(MenuIcons.tick, new Point(e.ImageRectangle.Left, e.ImageRectangle.Top));
        }
