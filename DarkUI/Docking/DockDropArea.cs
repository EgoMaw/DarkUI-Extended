...
namespace DarkUI.Docking
{
    internal class DockDropArea
    {
        ...
        internal DarkDockPanel DockPanel { get; }

        internal Rectangle DropArea { get; private set; }

        internal Rectangle HighlightArea { get; private set; }

        internal DarkDockRegion DockRegion { get; }

        internal DarkDockGroup DockGroup { get; }

        internal DockInsertType InsertType { get; }
        ...
        private void BuildRegionAreas()
        {
            switch (DockRegion.DockArea)
            {
                ...
                case DarkDockArea.Bottom:
                    ...
                    if (DockPanel.Regions[DarkDockArea.Right].Visible) width -= DockPanel.Regions[DarkDockArea.Right].Width;
