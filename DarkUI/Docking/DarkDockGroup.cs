...
namespace DarkUI.Docking
{
    ...
    public class DarkDockGroup : Panel
    {
        ...
        public DarkDockPanel DockPanel { get; }

        public DarkDockRegion DockRegion { get; }

        public DarkDockArea DockArea { get; }
        ...
        {
            return new(point.X - _tabArea.Offset, point.Y);
        }

        private Rectangle RectangleToTabArea(Rectangle rectangle)
        {
            return new(PointToTabArea(rectangle.Location), rectangle.Size);
        }
