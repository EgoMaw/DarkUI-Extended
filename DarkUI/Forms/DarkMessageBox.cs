...
namespace DarkUI.Forms
{
    public partial class DarkMessageBox : DarkDialog
    {
        ...
        public static DialogResult ShowQuestion(string message, string caption, DarkDialogButton buttons = DarkDialogButton.Ok)
        {
            return ShowDialog(message, caption, DarkMessageBoxIcon.Question, buttons);
        }

        public static DialogResult ShowAsterisk(string message, string caption, DarkDialogButton buttons = DarkDialogButton.Ok)
        {
            return ShowDialog(message, caption, DarkMessageBoxIcon.Asterisk, buttons);
        }

        public static DialogResult ShowExclamation(string message, string caption, DarkDialogButton buttons = DarkDialogButton.Ok)
        {
            return ShowDialog(message, caption, DarkMessageBoxIcon.Exclamation, buttons);
        }
        ...
        private void SetIcon(DarkMessageBoxIcon icon)
        {
            switch (icon)
            {
                ...
                case DarkMessageBoxIcon.Asterisk:
                    picIcon.Image = MessageBoxIcons.asterisk;
                    break;

                case DarkMessageBoxIcon.Exclamation:
                    picIcon.Image = MessageBoxIcons.exclamation;
                    break;
