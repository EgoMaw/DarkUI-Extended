    ...
    public class DarkListView : DarkScrollView
    {
        ...
        protected override void PaintContent(Graphics g)
        {
            ...
            for (var i = top; i <= bottom; i++)
            {
                ...
                // Icon
                if (ShowIcons && Items[i].Icon != null) g.DrawImageUnscaled(Items[i].Icon, new Point(rect.Left + 5, rect.Top + rect.Height / 2 - _iconSize / 2));
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            if (MultiSelect && ModifierKeys == Keys.Shift)
            {
                ...
                {
                    if (_anchoredItemEnd + 1 <= Items.Count - 1) SelectAnchoredRange(_anchoredItemEnd + 1);
                }
            }
            else
            {
