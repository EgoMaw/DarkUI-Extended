...
namespace DarkUI.Controls
{
    public class DarkScrollBar : Control
    {
        ...
        public void UpdateScrollBar()
        {
            ...
            else if (_scrollOrientation == DarkScrollOrientation.Horizontal) _trackArea = new Rectangle(area.Left + Consts.ArrowButtonSize, area.Top, area.Width - Consts.ArrowButtonSize * 2, area.Height);
