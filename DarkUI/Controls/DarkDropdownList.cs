    ...
    public class DarkDropdownList : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (SelectedItem != null)
            {
                ...
                if (hasIcon) g.DrawImageUnscaled(SelectedItem.Icon, new Point(ClientRectangle.Left + 5, ClientRectangle.Top + ClientRectangle.Height / 2 - _iconSize / 2));
        ...
        public ObservableCollection<DarkDropdownItem> Items { get; } = new();
